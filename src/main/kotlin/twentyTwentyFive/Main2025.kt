...
fun daySix() {
    val lines = readFileAsLinesUsingReadLines("src/main/resources/2025/DaySixInput.txt")
    println("Day 6:")
    println("Part One:")
    twentyTwentyFive.daySix.PartOne.execute(lines)
    println("Part Two:")
    twentyTwentyFive.daySix.PartTwo.execute(lines)
    println()
}