...
fun dayEleven() {
    val lines = readFileAsLinesUsingReadLines("src/main/resources/2023/DayElevenInput.txt")
    println("Day 11:")
    println("Part One:")
    twentyTwentyThree.dayEleven.PartOne.execute(lines)
    println("Part Two:")
    twentyTwentyThree.dayEleven.PartTwo.execute(lines)
    println()
}