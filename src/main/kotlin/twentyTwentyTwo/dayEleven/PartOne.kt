package twentyTwentyTwo.dayEleven
...
class PartOne {
    companion object {
        ...
        fun execute(lines: List<String>) {
            ...
            println("monkey business = ${highestTwoInspectations[0]} * ${highestTwoInspectations[1]} = " + (highestTwoInspectations[0] * highestTwoInspectations[1]))
        }
